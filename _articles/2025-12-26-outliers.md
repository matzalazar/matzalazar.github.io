...
Con datos reales, $\vec{y}$ casi nunca pertenece al espacio generado por las columnas de $A$.
...
![Gráfico 1]({{ site.baseurl }}/assets/img/posts/grafico-1.jpeg)

![Gráfico 2]({{ site.baseurl }}/assets/img/posts/grafico-2.jpeg)

El gráfico de residuos muestra que el error no se distribuye como ruido blanco: hay rangos donde el modelo subestima de forma consistente y otros donde sobreestima, además de puntos extremos que concentran gran parte del error.
...
Al repetir el entrenamiento cambiando únicamente el `random_state`, los coeficientes variaban.
