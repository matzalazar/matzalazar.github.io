...
<div class="contact-container">
  <div class="contact-copy">
    <p class="home-radical-kicker">contacto</p>
    ...
    <div class="contact-methods" style="margin-top: 3rem; font-size: 0.9em;">
      ...
      <ul style="list-style: none; padding: 0; margin: 0; line-height: 1.8;">
        <li><span style="opacity: 0.6; display: inline-block; width: 70px;">Email</span> <a href="mailto:matias.zalazar@icloud.com" style="text-decoration: none;">matias.zalazar@icloud.com</a></li>
  ...
  <form action="https://send.pageclip.co/hjTP8XjJFTT3wxOr5tmiVcAwakUy6Ca6" class="pageclip-form contact-form" method="post">
    ...
    <div class="form-group">
      ...
      <textarea name="message" id="message" required placeholder="Objetivo, contexto actual y qué te gustaría resolver." rows="4"></textarea>
    </div>

    <div class="form-actions">
      <button type="submit" class="pageclip-form__submit">
        <span>Enviar mensaje</span> <span aria-hidden="true">→</span>
      </button>
    </div>
  </form>
  </div>
